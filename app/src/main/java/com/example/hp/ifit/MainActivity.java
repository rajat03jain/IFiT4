...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_bed) {
            Intent ambulanceintent = new Intent(MainActivity.this, GetBed.class);
            startActivity(ambulanceintent);
            // Handle the camera action
        } else if (id == R.id.nav_call_ambulance) {
            Intent ambulanceintent = new Intent(MainActivity.this, CallAmbulance.class);
            startActivity(ambulanceintent);

        }  else if (id == R.id.nav_doctor) {
            Intent ambulanceintent = new Intent(MainActivity.this, GetDoctor.class);
            startActivity(ambulanceintent);

        } else if (id == R.id.nav_profile) {
            Intent ambulanceintent = new Intent(MainActivity.this, MyProfile.class);
            startActivity(ambulanceintent);
